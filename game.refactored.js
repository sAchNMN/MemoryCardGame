// game.js - Main entry (merged from layers by extract_layers_v5.py)
// Edit js/*.js for development, then re-run this script to build.

const { LEVELS, ACHIEVEMENTS, SHOP_ITEMS, SYMBOLS } = require('./js/config.js');
